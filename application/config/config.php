...
$config['url_normal'] = isset($_SERVER['REQUEST_URI'])?$_SERVER['REQUEST_URI']:"";
$_SERVER['REQUEST_URI'] = strtolower(isset($_SERVER['REQUEST_URI'])?$_SERVER['REQUEST_URI']:"");
/*
|--------------------------------------------------------------------------
| Base Site URL
|--------------------------------------------------------------------------
...
|
*/
$carpeta_principal = strtolower(str_replace(basename($_SERVER['SCRIPT_NAME']),"",$_SERVER['SCRIPT_NAME']));
$protocolo = isset($_SERVER["HTTP_X_FORWARDED_PROTO"]) ? 'https' : 'http';
$http_host = isset($_SERVER['HTTP_HOST'])?$_SERVER['HTTP_HOST']:"";
$config['base_url'] = $protocolo."://".$http_host.$carpeta_principal;
$config['carpeta_principal'] = $carpeta_principal;
/*
|--------------------------------------------------------------------------
| Index File
|--------------------------------------------------------------------------
...
$config['sess_save_path'] = $_SERVER['DOCUMENT_ROOT'].'\\'.$carpeta_principal.'\sesiones';
...
$config['clientes_array_columna'] = array('Razon Social', 'Vendedor', 'Cant. Facturas', 'Deuda', 'No Vencido', 'Vencido', 'Ponderado de pago');
